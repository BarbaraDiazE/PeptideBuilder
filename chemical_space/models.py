...
class FP(models.Model):
    pca_fp = MultiSelectField(verbose_name="Fingerprint", choices=FP_Keys, max_choices=1)
    tsne_fp = MultiSelectField(verbose_name="Fingerprint", choices=FP_Keys, max_choices=1)

class PP(models.Model):
    pca_pp = MultiSelectField(verbose_name="Phisicochemical", choices=PP_Keys, max_choices=1)
    tsne_pp = MultiSelectField(verbose_name="Phisicochemical", choices=PP_Keys, max_choices=1)    
